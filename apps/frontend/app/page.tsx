...
export default function LandingPage() {
  return (
    <div className="flex min-h-screen flex-col">
      <header className="flex h-16 items-center justify-between px-4 md:px-6 lg:px-8 max-w-7xl mx-auto w-full">
            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="flex flex-col justify-center space-y-5">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row pt-2">
                  <Link href="/register">
                    <Button className="bg-[#31A9B8] hover:bg-[#2a8f9c] text-lg px-6 py-2.5">無料で始める</Button>
                  </Link>
                </div>
              </div>
              <div className="flex items-center justify-center lg:justify-end">
                <div className="relative h-[350px] w-full max-w-[500px] overflow-hidden rounded-xl bg-white shadow-lg p-6 border border-gray-100">
                  ...
                  <div className="absolute top-1/4 left-6 max-w-[250px] rounded-lg bg-[#31A9B8] bg-opacity-10 p-4 shadow-sm">
                    <p className="text-sm font-medium">「今日のタスクは進んでいますか？」</p>
                    <p className="text-xs text-gray-500 mt-1">AIコーチ 10:30</p>
                  </div>
                  <div className="absolute bottom-24 right-6 max-w-[200px] rounded-lg bg-gray-100 p-4 shadow-sm">
            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-16 items-center">
              ...
              <div className="order-1 lg:order-2 flex items-center justify-center">
                <div className="relative h-[450px] w-full max-w-[550px] overflow-hidden rounded-xl bg-gradient-to-br from-gray-50 to-blue-50 p-6 shadow-lg border border-gray-100">
                  <div className="absolute left-8 top-8 flex h-12 w-12 items-center justify-center rounded-full bg-[#31A9B8] text-white shadow-md">
                    <span className="text-lg font-medium">AI</span>
                  </div>
                  <div className="absolute left-8 top-28 max-w-[320px] rounded-lg bg-white p-4 shadow-md border-l-4 border-[#31A9B8]">
                    <p className="text-base font-medium">「まだ終わってないんですか？締め切りまであと3時間ですよ！」</p>
                    <p className="text-xs text-gray-500 mt-2">AIコーチ 14:30</p>
                  </div>
                  <div className="absolute right-8 top-48 max-w-[220px] rounded-lg bg-gray-200 p-4 shadow-md">
                    <p className="text-base">「あと少しで終わります...」</p>
                    <p className="text-xs text-gray-500 mt-2">あなた 14:32</p>
                  </div>
                  <div className="absolute left-8 bottom-28 max-w-[320px] rounded-lg bg-white p-4 shadow-md border-l-4 border-[#31A9B8]">
        ...
        <div className="container px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-wrap gap-8 text-sm text-gray-600">
              <Link href="#" className="hover:text-[#31A9B8] transition-colors">利用規約</Link>
              <Link href="#" className="hover:text-[#31A9B8] transition-colors">プライバシーポリシー</Link>
              <Link href="#" className="hover:text-[#31A9B8] transition-colors">お問い合わせ</Link>
            </div>
